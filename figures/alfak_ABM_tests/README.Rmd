...
p3 <- ggplot(z,aes(x=as.character(as.numeric(gsub("t","",variable))/10),
                   y=value,fill=gsub("p",".",wavelength)))+
...
ggsave("figures/alfak_ABM_tests/figs/validation_angles.png",width=12,height=4.5,units="in")
```
