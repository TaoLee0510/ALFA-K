...
cmds <- lapply(ff, function(fi){
  ...
  conditions <- c()
  if(fi=="SA535_CISPLATIN_CombinedH_X7_l_3_d1_0_d2_0.Rds"){
    conditions <- c(0.0004,0.0006,0.001,0.002,0.003)
  }
  if(fi=="SA906a_X57_l_7_d1_0_d2_0.Rds"){
    conditions <- c(0.001,0.002,0.003,0.004,0.005)
  }
